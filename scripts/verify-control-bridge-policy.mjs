...
assert.match(browserService, /browser --browser-profile openclaw start/, 'managed browser service must start only the named operator profile');
assert.match(browserService, /browser --browser-profile openclaw doctor/, 'managed browser service must verify browser readiness');
