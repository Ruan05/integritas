...
drop function if exists public.integritas_finalize_document_delete(uuid,uuid);
...
drop function if exists integritas_private.integritas_finalize_document_delete(uuid,uuid);
